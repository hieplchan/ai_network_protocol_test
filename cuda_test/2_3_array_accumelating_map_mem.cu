...
int main() {
    ...
    // Host memmory alloc
    int *h_a, *h_b, *h_c;
    cudaHostAlloc((int **)&h_a, NUM_BYTES, cudaHostAllocMapped);
    cudaHostAlloc((int **)&h_b, NUM_BYTES, cudaHostAllocMapped);
    cudaHostAlloc((int **)&h_c, NUM_BYTES, cudaHostAllocMapped);
    ...
    int *d_a, *d_b, *d_c;
    cudaHostGetDevicePointer((int **)&d_a, (int *)h_a, 0);
    cudaHostGetDevicePointer((int **)&d_b, (int *)h_b, 0);
    cudaHostGetDevicePointer((int **)&d_c, (int *)h_c, 0);
